sap.ui.jsview("smpdemo.AccountMaster", {
	...
	createContent : function(oController) {
		...
		var search = new sap.m.Bar({
			contentMiddle : [ new sap.m.SearchField("accountSearch", {
				search : [ oController.handleCustomerSearch, oController ]
			}) ]
		});

		// create a List control
		var list = new sap.m.List("accountListItems");
		...
		// Page footer
		var footer = new sap.m.Bar("masterFooter", {});
